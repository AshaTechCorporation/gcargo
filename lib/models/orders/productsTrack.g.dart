...
ProductsTrack _$ProductsTrackFromJson(Map<String, dynamic> json) =>
    ProductsTrack(
      ...
      (json['add_on_services'] as List<dynamic>?)
          ?.map((e) => PartAddOnTrack.fromJson(e as Map<String, dynamic>))
          .toList(),
      (json['options'] as List<dynamic>?)
          ?.map((e) => OptionsOrdersTeack.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$ProductsTrackToJson(ProductsTrack instance) =>
    <String, dynamic>{
