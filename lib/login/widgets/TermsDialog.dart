...
import 'package:gcargo/widgets/html_text_widget.dart';

class TermsDialog extends StatefulWidget {
  final String? termsContent;

  const TermsDialog({super.key, this.termsContent});
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(' ', style: TextStyle(fontSize: isPhone(context) ? 22 : 16, fontWeight: FontWeight.bold, color: Colors.black)),
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child:
                      widget.termsContent != null && widget.termsContent!.isNotEmpty
                          ? HtmlTextWidget(htmlContent: widget.termsContent!)
                          : Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
