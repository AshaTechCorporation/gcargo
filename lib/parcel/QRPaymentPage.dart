...
class QRPaymentPage extends StatefulWidget {
  QRPaymentPage({super.key, required this.totalPrice, required this.ref_no, required this.orderType, required this.vat});
  ...
  void _showImagePickerDialog() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(getTranslation('select_image')),
          content: Column(
          ...
          uploadedImage == null
              ? Column(
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(getTranslation('upload_payment_slip'), style: const TextStyle(fontWeight: FontWeight.bold)),
                  const SizedBox(height: 4),
                  ...
                  OutlinedButton(
                    ...
                    child: Text(getTranslation('select_image'), style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                  ),
                ],
              )
              : Column(
                children: [
                  ...
                  const SizedBox(height: 12),
                  Text(getTranslation('upload_slip'), style: const TextStyle(fontWeight: FontWeight.bold)),
                  const SizedBox(height: 8),
                  OutlinedButton(
                    onPressed: _showImagePickerDialog,
                    style: OutlinedButton.styleFrom(
                    ...
                    child: Text(getTranslation('change_image'), style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                  ),
                ],
              ),
    );
