        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                widget.isSetup 
                    ? (isConfirming ? 'ยืนยันรหัส PIN' : 'ตั้งรหัส PIN')
                    : 'ใส่รหัส PIN',
              ...
              Text(
                widget.isSetup
                    ? (isConfirming ? 'ใส่รหัส PIN อีกครั้งเพื่อยืนยัน' : 'ตั้งรหัส PIN 4 หลักเพื่อความปลอดภัย')
                ...
                children: List.generate(4, (index) {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: index < currentPin.length ? kButtonColor : Colors.grey.shade300,
                    ),
                  );
                }),
              ),
